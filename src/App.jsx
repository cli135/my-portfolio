    ...
    <div className="min-h-screen bg-gray-100 font-mono">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <h1 className="text-3xl font-bold text-gray-900">Christopher Li</h1>
          <div className="flex space-x-4">
            <a href="https://github.com/cli135" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black">
            ...
            <a href="https://linkedin.com/in/christopher-yin-li" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-400">
              &copy; 2024 Christopher Li. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
